...
| **(d)** | Pre-Geometry + Variant B (Window Objectness) | `config.yaml` | `719482b` | 0.165103 | 0.100600 | 0.257257 | 0.422371 | 0.330892 | 0.371077 | 5060 | 6920 | 10232 | 0.299820 *(derived)* | 0.566230 *(derived)* | 0.398110 *(derived)* | 0.467270 *(derived)* | 175.99 | Superseded by Arm 2 |
| **(e)** | Pre-Geometry + Var B + Arm 2 Box Regressor | `config.yaml` | `1f5ccae` | **0.258616** | **0.226600** | **0.304353** | **0.580217** | **0.454551** | **0.509754** | **6951** | **5029** | **8341** | **0.394014** *(derived)* | **0.726432** *(derived)* | **0.510740** *(derived)* | **0.599950** *(derived)* | 80.69 | **FINAL SHIPPING CONFIG (VERIFIED & CONTAINER TESTED)** |
...
*Notes:*
- *FINAL SUBMISSION ARTIFACT RE-FROZEN at `1f5ccae`, `image.tar` 189,846,016 B, offline run 30.62 min (1837.17 s), all-21 mAP 0.284406, 21/21 detection counts matched (16,955 total detections across 63 validated .txt files).*
- *Container ALL-21 Verified: mAP 0.284406, Precision 0.623120, Recall 0.472327, F1 0.537345, TP 10565, FP 6390, FN 11803 (18/21 sequences meet Pass-1 $p_{99} < 40\text{ ms}$; mean compute throughput 12.70 ms/win).*
- *Test split metrics for Final Shipping Config (e) derived by subtracting Train-17 counts (TP 6951, FP 5029, FN 8341) from Container All-21 counts (TP 10565, FP 6390, FN 11803) yielding Test TP 3614, FP 1361, FN 3462 (TP+FP = 4,975; TP+FN = 7,076; Precision 0.726432, Recall 0.510740, F1 0.599950, mAP 0.394014).*
