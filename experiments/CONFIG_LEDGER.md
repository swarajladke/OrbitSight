...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| **(a)** | Pre-Geometry + No Rerank | `configs/pre_geometry.yaml` | `dcc8787` | **0.155493** | 0.056048 | 0.275328 | 0.281011 | 0.335993 | 0.306052 | 5138 | 13146 | 10154 | **0.303022** | 0.4765 | 0.4072 | **0.4392** | 113.3 | **SHIPPING CANDIDATE** |
...
| **(d)** | Pre-Geometry + Variant B (Window Objectness) | `configs/pre_geometry.yaml` | `HEAD` | *MEASURING* | *MEASURING* | *MEASURING* | *MEASURING* | *MEASURING* | *MEASURING* | *MEASURING* | *MEASURING* | *MEASURING* | *MEASURING* | *MEASURING* | *MEASURING* | *MEASURING* | 113.3 | Target Cell |
