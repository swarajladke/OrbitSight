...
| **(e)** | Pre-Geometry + Var B + Arm 2 Box Regressor | `config.yaml` | `cf7eb67` | **0.258616** | **0.226600** | **0.304353** | **0.580217** | **0.454551** | **0.509754** | **6951** | **5029** | **8341** | **0.394014** *(derived)* | **0.726432** *(derived)* | **0.510740** *(derived)* | **0.599784** *(derived)* | UNMEASURED | **FINAL SHIPPING CONFIG (VERIFIED & CONTAINER TESTED)** |
