...
| **(d)** | Pre-Geometry + Variant B (Window Objectness) | `config.yaml` | `1042d8b` | **0.163628** | **0.098205** | 0.257091 | 0.422441 | 0.330892 | **0.371104** | 5060 | **6918** | 10232 | UNMEASURED | UNMEASURED | UNMEASURED | UNMEASURED | 113.3 | **SHIPPING CONFIG (FROZEN & VERIFIED)** |
