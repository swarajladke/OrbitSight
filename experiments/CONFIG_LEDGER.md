...
| **(e)** | Pre-Geometry + Var B + Arm 2 Box Regressor | `config.yaml` | `30ffcbf` | **0.258616** | **0.226600** | **0.304353** | **0.580217** | **0.454551** | **0.509754** | **6951** | **5029** | **8341** | **0.394014** *(derived)* | **0.726432** *(derived)* | **0.510740** *(derived)* | **0.599784** *(derived)* | UNMEASURED | **FINAL SHIPPING CONFIG (VERIFIED & CONTAINER TESTED)** |
...
*Notes:*
- *FINAL SUBMISSION ARTIFACT RE-FROZEN at `30ffcbf`, `image.tar` 189,846,016 B, offline run 30.62 min (1837.17 s across 143,750 windows = 12.78 ms/window throughput, within pre-regressor range 9.65-13.12 ms/win on identical code), all-21 mAP 0.284406, 21/21 detection counts matched (16,955 total detections across 63 validated .txt files).*
